...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "42e0f237-83b6-4eb4-98bb-a65dcd714d02",
                            Name = "Student",
                            NormalizedName = "STUDENT"
                        },
                        new
                        {
                            Id = "84b8a3f3-5e3a-4ccf-ba3a-aa491bf4c526",
                            Name = "Lecturer",
                            NormalizedName = "LECTURER"
                        },
                        new
                        {
                            Id = "4eba114c-157e-4dde-a250-49b01359adbd",
                            Name = "Advisor",
                            NormalizedName = "ADVISOR"
                        },
                        new
                        {
                            Id = "64074a62-7b82-4262-9946-f9bff786b5fe",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("api.Models.CourseClass", b =>
                {
            ...
            modelBuilder.Entity("api.Models.CourseExplanation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("api.Models.CourseExplanation", b =>
                {
                    b.HasOne("api.Models.Course", "Course")
                        .WithOne("Explanation")
                        .HasForeignKey("api.Models.CourseExplanation", "CourseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
