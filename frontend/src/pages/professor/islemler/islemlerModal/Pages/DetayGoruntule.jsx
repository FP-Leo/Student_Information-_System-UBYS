...
export default function DetayGoruntule({ course,faculty,department,courseSize }) {
  ...
  const handleSetAkts =  async ( ) =>{
    const response = await axios.get(
      `https://localhost:${PORT}/api/University/Faculty/Department/Course/Class/Code?CourseCode=BLM-2001`,
      {
        headers:{
